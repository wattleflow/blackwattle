...
# Measured: `asymmetric` imports `cryptography` at module level, so the eager
# form made this package — and its parent — unimportable without the `security`
# extra, while `hashlib` needs nothing but the standard library.
#
...
_EXPORTS: dict[str, str] = {
    "StrategyBaseRSA": "asymmetric",
    "StrategyRSAEncrypt256": "asymmetric",
    "StrategyRSADecrypt256": "asymmetric",
    "StrategyRSAEncrypt512": "asymmetric",
    "StrategyRSADecrypt512": "asymmetric",
    "StrategyFernetGeneric": "fernet",
    "StrategyFernetEncrypt": "fernet",
    "StrategyFernetDecrypt": "fernet",
    "StrategyMD5": "hashlib",
    "StrategySha224": "hashlib",
    "StrategySha256": "hashlib",
    "StrategySha384": "hashlib",
    "StrategySha512": "hashlib",
}
