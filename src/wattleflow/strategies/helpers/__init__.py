# Module name: strategies/helpers/__init__.py
...
# The eager form here was reached through the parent aggregate, which pulled
# `cryptography` before this package was consulted at all (DR-WFL-007: the
# deferral must survive the aggregate).
#
...
_EXPORTS: dict[str, str] = {
    "StrategyFilename": "files",
    "StrategyFilterFiles": "files",
    "StrategyCopyHuggingfaceModels": "huggingface",
