...
_EXPORTS: dict[str, str] = {
    "CreateAvroDocument": "avro",
    "ReadAvroDocument": "avro",
    "WriteAvroDocument": "avro",
    "CreateDataframeDocument": "dataframe",
    "WriteDataframeDocument": "dataframe",
    "CreateFileDocument": "file",
    "ReadDocumentFile": "file",
    "WriteDocumentToFile": "file",
    "CreateGraphFromHtml": "graph",
    "WriteGraphHtmlDocument": "graph",
    "CreateJsonDocument": "json",
    "ReadJsonDocument": "json",
    "WriteJsonDocument": "json",
    "CreateMarkdownFileDocument": "word",
    "ReadWordDocument": "word",
    "WriteMarkdownToWordDocument": "word",
    "CreateOpenSearchDocument": "opensearch",
    ...
    "WriteEntityAnnotations": "annotations",
    "CreateEmailDocument": "mail",
    "WriteEmailAttachments": "mail",
    "WriteEmailCopy": "mail",
    "WriteEmailCopyOLD": "mail",
    "WriteEmailText": "mail",
    "WriteEmailWithAttachmentOLD": "mail",
    "CreatePdfDocument": "pdf",
    "PdfArchiveName": "pdf",
    "WritePdfArchive": "pdf",
    "WritePdfPerPageToFile": "pdf",
    "WritePdfRedactedToFile": "pdf",
    "CreateProtobufDocument": "protobuf",
    "ReadProtobufDocument": "protobuf",
    "WriteProtobufDocument": "protobuf",
    "WriteDocumentRecords": "records",
    "WriteQualityReport": "records",
    "ReadDocumentRecords": "records",
    "ReadRssDocument": "rss",
    "ReadXmlDocument": "xml",
    "CreateSolrDocument": "solr",
    "ReadSolrDocument": "solr",
    "WriteSolrDocument": "solr",
    "CreateTextDocument": "text",
    "WriteTextDocument": "text",
    "WriteTextContent": "text",
    "CreateYoutubeDocument": "youtube",
    "WriteYoutubeDocument": "youtube",
}
...
__all__ = [
    ...
    "ReadJsonDocument",
    "WriteJsonDocument",
    "CreateMarkdownFileDocument",
    "ReadWordDocument",
    "WriteMarkdownToWordDocument",
    "CreateOpenSearchDocument",
    "ReadOpenSearchDocument",
    "WriteOpenSearchDocument",
    "CreateOrcDocument",
    "ReadOrcDocument",
    "WriteOrcDocument",
    "WriteRedactedImage",
    "WriteEntityAnnotations",
    "CreateEmailDocument",
    ...
    "ReadProtobufDocument",
    "WriteProtobufDocument",
